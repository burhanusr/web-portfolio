...
export default function Footer() {
  return (
    <footer className="relative z-30 flex h-36 flex-col items-center justify-center border-t border-[#fafaf6] bg-[#1d1d1f]">
      ...
      <div className="mt-4 text-sm font-medium text-white md:text-base">
        <p>Crafted with ❤️ by Burhanu Sultan Ramadan</p>
      </div>
    </footer>
  );
}
