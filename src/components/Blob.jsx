...
export default function Blob() {
  ...
  return (
    <>
      <div
        id="blob"
        className="fixed left-1/2 top-1/2 z-10 aspect-square h-[500px] -translate-x-1/2 -translate-y-1/2 animate-blob rounded-full bg-gradient-to-r from-yellow-500 to-purple-500 blur-[130px]"
      ></div>
